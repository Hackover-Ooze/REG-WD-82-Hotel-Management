      ...
      <div>
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
          <div className="container-fluid">
            <a className="navbar-brand" href="#" style={{ color: "#CD5C5C" }}><b>Inventory Management System</b></a>
          ...
          <div className="students" style={{marginLeft: "200px" }}>
            {this.state.filteredData.length === 0 ? (<div className="alert alert-danger" style={{ marginLeft: "300px", width: "20%"}}>
              ...
              return(
                ...
                <div className="student" style={{ background: "#DCDCDC", width: "350px",height:"450px" ,marginRight: "40px",marginTop:"30px"}}>
