              ...
              <div className="solution_cards_box">
                <div className="solution_card">
                  ...
                  <div className="solu_description">
                    <p>
                      <img src={"stkmng1.jpg"} style={{ width: "150px", height: "150px" }} />
                    </p>
                    <Link to="/login"><button type="button" className="read_more_btn">Login</button></Link>
                  </div>
                </div>
                <div className="solution_card" style={{ opacity: "1" }}>
                  <div className="hover_color_bubble"></div>
                  <div className="so_top_icon">
                    <svg id="Layer_1" enable-background="new 0 0 512 512" height="50" viewBox="0 0 512 512" width="40" xmlns="http://www.w3.org/2000/svg">
                      <g>
